...
export class PortalhomeComponent implements OnInit {
  ...
  startsearch()
  {
    ...
    var searchresult = document.getElementById("searchresult") as HTMLElement;
    ...
    if((this.searchcustomerid == undefined)||(this.searchloanid == undefined))
      ...
      //https://localhost:5003/api/LoanManagement/getsanctionedloans/
      this.http
        .get(
          'https://localhost:5003/api/LoanManagement/getsanctionedloans/'+this.searchloanid+'/'+this.searchcustomerid,
          httpOptions
        )
        .subscribe(
          (response) => { 
    ...
    this.http
      ...
      .subscribe(
        (response) => {
          ...
          this.items.sort(function (x:any, y:any){
            return (x.isCollateralIssued === y.isCollateralIssued) ? 0 : x ? -1 : 1;
          })
